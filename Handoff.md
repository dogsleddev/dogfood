...
### State (2026-06-21, latest · next-steps review + steps 1–5: truthful guides + edge access gate + decisions + scenario store unified + scenario persistence) — GREEN  ·  _authoritative; the blocks below are prior context_
